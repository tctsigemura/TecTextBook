...
\myfigureN{btp}{scale=0.45}{chap3/handa.pdf}
          {ハンダ付け手順}{chap3:handa}
...
\myfigureN{tbp}{scale=0.8}{Tikz/leds2.pdf}{LEDの配置}{chap3:leds2}
...
\myfigureN{tbp}{scale=1.2}{Tikz/cn.pdf}{JTAG コネクタ}{chap3:cn}
...
\myfigureN{tbp}{scale=0.6}{chap3/cnn.pdf}{入出力ポートコネクタ}{chap3:cnn}
...
\myfigureN{tbp}{scale=0.7}{chap3/cn1.pdf}{電源コネクタ}{chap3:cn1}
